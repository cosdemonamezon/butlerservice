...
const List<Map<String, dynamic>> customer = [
  {
    'id': 1,
    'image': 'assets/icons/mdi_add-location.png',
    'text': 'ลงทะเบียน \n สถานที่'
  },
  {
    'id': 2,
  ...
  {
    'id': 3,
    'image': 'assets/icons/mdi_file-report.png',
    'text': 'ประวัติ \n การตรวจ'
  },{
    'id': 4,
    'image': 'assets/icons/akar-icons_stop-fill.png',
    'text': 'ร้องเรียน'
  }  
];
...
const List<Map<String, dynamic>> members = [
  {
    ...
    'name': 'นาย มั่นคง ขยันยิ่ง'
  },
  {
    'id': 2,
    'image': 'assets/images/per2.png',
    'name': 'นาย มุ่งมั่น ขยันยิ่ง'
  },
  {
    'id': 3,
...
const List<Map<String, dynamic>> patrol = [
  {
    'id': 1,
    'image': 'assets/icons/fluent_folder-people-20-filled.png',
    'text': 'รายงาน \n ผลตรวจ'
  },
  {
    'id': 2,
    'image': 'assets/icons/fluent_people-settings-24-filled.png',
    'text': 'ตั้งค่า \n กลุ่มงาน'
  },
  {
    'id': 3,
...
const List<Map<String, dynamic>> officer = [
  {
    'id': 1,
    'image': 'assets/icons/hometu.png',
    'text': 'เเจ้งผู้มาเยี่ยม \n เจ้าบ้าน'
  },
  {
    'id': 2,
    'image': 'assets/icons/mdi_file-report.png',
...
const List<Map<String, dynamic>> iconImage = [
  {
    'id': 1,
    'icon': 'assets/icons/ion_home.png',
    'text': 'บ้านเดี่ยว'
  },
  {
    'id': 2,
    'icon': 'assets/icons/bxs_building.png',
    'text': 'อาคาร'
  },
  {
    'id': 3,
    'icon': 'assets/icons/ion_condo.png',
    'text': 'คอนโด'
  },
  {
    'id': 4,
    'icon': 'assets/icons/ion_office.png',
    'text': 'ออฟฟิศ'
  },
  {
    'id': 5,
    'icon': 'assets/icons/ion_factory.png',
    'text': 'โรงงาน'
  }  
